...
` +
    ...
    var je = Object.prototype.hasOwnProperty,
      Me = n.unstable_scheduleCallback,
      Ne = n.unstable_cancelCallback,
      Pe = n.unstable_shouldYield,
      Fe = n.unstable_requestPaint,
      Ie = n.unstable_now,
      Le = n.unstable_getCurrentPriorityLevel,
      Re = n.unstable_ImmediatePriority,
      ze = n.unstable_UserBlockingPriority,
      Be = n.unstable_NormalPriority,
      Ve = n.unstable_LowPriority,
      He = n.unstable_IdlePriority,
      Ue = n.log,
      We = n.unstable_setDisableYieldValue,
      Ge = null,
      Ke = null;
    function qe(e) {
      if (
    ...
    function Si(e, t, n, r, i, o) {
      ...
      if (((r = e), typeof e == `function`)) yi(e) && (s = 1);
        ...
        a: switch (e) {
          case C:
            return (e = vi(31, n, t, i)), (e.elementType = C), (e.lanes = o), e;
          case _:
          ...
          case y:
            return (
              (e = vi(12, n, t, i | 2)), (e.elementType = y), (e.lanes = o), e
            );
          case re:
            return (
              (e = vi(13, n, t, i)), (e.elementType = re), (e.lanes = o), e
            );
          case S:
            return (e = vi(19, n, t, i)), (e.elementType = S), (e.lanes = o), e;
          default:
    ...
    function Ga(e) {
      ...
      function b(e, r, o, c) {
        if (
          ...
          if (o.$$typeof === ee) return b(e, r, da(e, o), c);
          Wa(e, o);
        }
...
`
    ...
    e.hydrateRoot = function (e, t, n) {
      ...
      return (
        ...
        (t = ep(e, 1, !0, t, n ?? null, r, i, u, s, c, l, Pp)),
        (t.context = tp(null)),
        (n = t.current),
        (r = pu()),
        (r = ft(r)),
  ...
  ie = u(te(), 1);
function ae(e) {
  return S.createElement(h, { flushSync: ie.flushSync, ...e });
}
var C = null,
  oe = null;
function se() {
...
function ce({ unstable_getContext: e }) {
  if ((se(), !C))
    throw Error(
  ...
  if (!C.stateDecodingPromise) {
    ...
    a(e, `No stream found for single fetch decoding`),
      (C.context.stream = void 0),
      (C.stateDecodingPromise = d(e, window)
        .then((e) => {
          (C.context.state = e.value), (t.stateDecodingPromise.value = !0);
        })
        .catch((e) => {
          t.stateDecodingPromise.error = e;
        }));
  }
  ...
  if (C.context.isSpaMode) {
    ...
    (u = c(
      ...
      u && u.errors && (u.errors = l(u.errors));
  let f = m({
    routes: n,
    history: _(),
    ...
    hydrationData: u,
    hydrationRouteProperties: y,
    mapRouteProperties: r,
    future: { unstable_middleware: C.context.future.unstable_middleware },
    dataStrategy: v(
      () => f,
      C.manifest,
      C.routeModules,
  ...
  return (
    (C.router = f),
    f.state.initialized && ((C.routerInitialized = !0), f.initialize()),
    (f.createRoutesForHMR = s),
    (window.__reactRouterDataRouter = f),
    f
  );
}
function le(t) {
  oe ||= ce({ unstable_getContext: t.unstable_getContext });
  let [n, r] = S.useState(void 0),
    [i, o] = S.useState(oe.state.location);
  return (
    S.useLayoutEffect(() => {
      C &&
        C.router &&
    ...
    S.useLayoutEffect(() => {
      if (C && C.router)
        return C.router.subscribe((e) => {
          e.location !== i && o(e.location);
        });
    }, [i]),
    a(C, `ssrInfo unavailable for HydratedRouter`),
    e(
      oe,
      C.manifest,
      C.routeModules,
    ...
    S.createElement(
      ...
      S.createElement(
        ...
        S.createElement(p, { location: i }, S.createElement(ae, { router: oe }))
      ),
...
(0, S.startTransition)(() => {
  (0, re.hydrateRoot)(
    document,
    (0, ue.jsx)(S.StrictMode, { children: (0, ue.jsx)(le, {}) })
  );
});
